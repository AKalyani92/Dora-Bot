/**
 * Created by aditi.kalyani on 09-08-2017.
 */
...
var connector = new builder.ChatConnector({
    appId: 'b49c8a57-0e52-4bbd-8b88-84346542e6ec',
    appPassword:'w4Mhs7DZfVZeNNbRNbayz98'
});
...
bot.dialog('/Analytics',[
    function (session,args) {
        builder.Prompts.choice(session,Â "Please select a dashboard",Â "CPO Dashboard|Supplier Visibility|Manager Dashboard|Supplier Compliance",
        {
